	...
	<form class="utmc__form" action="/" method="post">
		...
		<div id="app">
			...
			<div class="utmc__flex-wrap">
				...
				<v-select taggable :options="sources" name="utm_source" class="utmc__text-field" placeholder="utm_source" v-model="utm_source"></v-select>

				<v-select taggable :options="media"  name="utm_media" class="utmc__text-field" placeholder="utm_media" v-model="utm_media"></v-select>

				<input type="text" name="utm_campaign" class="utmc__text-field" placeholder="utm_campaign" v-model="utm_campaign">

				<input type="text" name="utm_content" class="utmc__text-field" placeholder="utm_content" v-model="utm_content">

				<input type="text" name="utm_term" class="utmc__text-field" placeholder="utm_term" v-model="utm_term">

				<input type="text" name="utmc_result" class="utmc__text-field utmc__result" v-bind:value="result" placeholder="result here...">
...
<script src="<?php echo utmc_resource( 'utmc.js' ) ?>"></script>
<script src="<?php echo utmc_resource( 'addLink.js' ) ?>"></script>
